...
export const SMTP_PORT: number = parseInt(
...
export const JWT_EXPIRY_LIMIT: number = parseInt(
process.env.JWT_EXPIRY_LIMIT!,
);
...
export const TOTP_DIGITS: number = parseInt(
process.env.TOTP_DIGITS!,
);
export const TOTP_PERIOD: number = parseInt(
