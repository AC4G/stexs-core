...
class JWTError extends Error {
	...
	constructor(info: { code: string, message: string }, status: number, data?: Record<string, object>) {
		super(info.message);
		this.code = info.code;
		this.status = status;
		this.data = data;
...
export function transformJwtErrorMessages(err: JWTError, req: Request, res: Response) {
